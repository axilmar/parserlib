...
1. [Operator Table](#operator-table)
1. [Loop Zero Or More Times](#loop-zero-or-more-times)
1. [Loop One Or More Times](#loop-one-or-more-times)
1. [Optional](#optional)
1. [Logical And](#logical-and)
1. [Logical Not](#logical-not)
1. [Sequence](#sequence)
1. [Choice](#choice)
