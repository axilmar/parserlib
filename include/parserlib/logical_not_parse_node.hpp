...
namespace parserlib {
    ...
    class logical_not_parse_node : public interface::parse_node {
    public:
        logical_not_parse_node(const parserlib::parse_node& child) : m_child(child) {
        }
    ...
    inline parse_node parse_node::operator !() const {
        return interface::create_parse_node<logical_not_parse_node>(*this);
    }
