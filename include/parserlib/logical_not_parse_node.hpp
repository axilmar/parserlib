...
namespace parserlib {
     ...
     * returning the opposite of the result of the child node.
     * It can be used as a logical predicate.
     * @param ParseNode type of child parse node.
     */
    template <class ParseNode>
    class logical_not_parse_node : public parse_node<logical_not_parse_node<ParseNode>> {
    public:
        /**
         * The constructor.
         ...
         * @return the opposite of the result of the child parse node.
         */
