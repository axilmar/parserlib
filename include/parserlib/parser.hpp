...
namespace parserlib {
    ...
    public:
         ...
         */
        auto operator [](std::size_t count) const;

        /**
         * Returns a pointer to derived class.
         * @return a pointer to derived class.
         */
        const Derived* pointer_to_derived() const {
    ...
    template <class Derived>
    auto parser<Derived>::operator *() const {
    ...
    template <class Derived>
    auto parser<Derived>::operator [](std::size_t count) const {
